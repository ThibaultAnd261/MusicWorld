            ...
            <div className="relative bg-gradient-to-t from-[#fffbf5] to-[#fffef4] p-10">
                <div className="flex justify-around flex-col sm:flex-row items-center">
                    <div className="content">
                        ...
                        <p className="text-4xl md:text-5xl font-bold leading-tight mt-5 sm:mt-0 break-words">
                        ...
                        <p className="text-md mt-5 md:text-lg ">
                            Sortie : {props.releaseList ? props.releaseList.release_date : "undefined"} | {props.releaseList ? <span className="capitalize">{props.releaseList.type}</span> : "undefined"} | {props.releaseList ? props.releaseList.total_tracks + " tracks" : "undefined"}
                        </p>
